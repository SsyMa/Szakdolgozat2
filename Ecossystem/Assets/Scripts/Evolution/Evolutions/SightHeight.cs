...
public class SightHeight : Evolution
{
    private void Awake()
    {
        cost = 10;
        ...
        brokeTimer = 0;
        valueIncrease = 1;
        description = "Increases the sight height of the creatures by +" + valueIncrease;
        numberOfLevels = 25;
        currentLevel = 0;
        prequisites = new();
    ...
    override public void OnClick()
    {
        ...
        if (currentLevel < numberOfLevels && cm.Spend(cost))
        {
            cost += costIncrease;
            currentLevel++;
            em.IncreaseSightHeightServerRpc(valueIncrease);
        }
        else
        {
